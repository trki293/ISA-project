...
const CreateResponseForCottageComplaint = () => {
    ...
    const createCottageComplaint = () => {
        axios
            .post("http://localhost:8080/cottage_complaints/createResponseForCottageComplaint", {
                adminSystemEmail : localStorage.getItem("userEmail"),
                cottageComplaintId : complaintId,
                text : content
            }, {
    ...
    return (
        <div>
            <br />
            <br />
            <TextField label="ID of Cottage Complaint" value={complaintId} id="outlined-basic" variant="outlined" size="small" />
            <br />
            <br />
            <TextField
            ...
            <br />
            <br />
            <Button onClick={() => createCottageComplaint()} variant="contained" color="primary">Create Response</Button>
            <br />
            <br />
...
export default CreateResponseForCottageComplaint;