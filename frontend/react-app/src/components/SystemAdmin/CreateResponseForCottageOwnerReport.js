...
const CreateResponseForCottageOwner = () => {
    ...
    const createCottageOwnerReport = () => {
        axios
            .put("http://localhost:8080/cottage_owner_reports/change_status", {
                statusOfReport : stateOfRequest,
                cottageOwnerReportId : reportId
            }, {
    ...
    return (
        <div>
            ...
            <br />
            <br />
            <Button onClick={() => createCottageOwnerReport()} variant="contained" color="primary">Create Response</Button>
            <br />
            <br />
...
export default CreateResponseForCottageOwner;