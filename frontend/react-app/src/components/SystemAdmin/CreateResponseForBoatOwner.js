...
const CreateResponseForBoatOwner = () => {
    ...
    const createBoatOwnerReport = () => {
        axios
            .put("http://localhost:8080/boat_owner_reports/change_status", {
                statusOfReport : stateOfRequest,
                boatOwnerReportId : reportId
            }, {
    ...
    return (
        <div>
            <br />
            <br />
            <TextField label="ID of Boat Owner Report" value={reportId} id="outlined-basic" variant="outlined" size="small" />
            <br />
            <br />
            ...
            <br />
            <br />
            <Button onClick={() => createBoatOwnerReport()} variant="contained" color="primary">Create Response</Button>
            <br />
            <br />
...
export default CreateResponseForBoatOwner;