...
const CreateBoatComplaint = () => {
    ...
    const createBoatComplaint = () => {
        axios
            .post("http://localhost:8080/boat_complaints/createBoatComplaint", {
                boatId: boatId,
    ...
    return (
        <div>
            ...
            <br />
            <br />
            <Button onClick={() => createBoatComplaint()} variant="contained" color="primary">Create Complaint</Button>
            <br />
            <br />
...
export default CreateBoatComplaint;