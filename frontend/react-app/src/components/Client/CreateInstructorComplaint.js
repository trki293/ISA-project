...
const CreateInstructorComplaint = () => {
    ...
    useEffect(() => {
        ...
        setInstructorId(splitID[6]);
    }, []);

    const createInstructionsComplaint = () => {
        axios
            .post("http://localhost:8080/instructions_complaints/createInstructionsComplaint", {
    ...
    return (
        <div>
            <br />
            <br />
            <TextField label="ID of Instructor" value={instructorId} id="outlined-basic" variant="outlined" size="small" />
            <br />
            <br />
            <TextField
            ...
            <br />
            <br />
            <Button onClick={() => createInstructionsComplaint()} variant="contained" color="primary">Create Complaint</Button>
            <br />
            <br />
...
export default CreateInstructorComplaint;