...
const CreateCottageReservation = () => {
    ...
    useEffect(() => {
        ...
        alert(splitID[5]);
        setCottageId(splitID[5]);
        setBeginDate(splitID[6]);
        setEndDate(splitID[7]);

        axios
            .get("http://localhost:8080/cottages/getAdditionalServicesForCottage/" + splitID[5], {
    ...
    const createCottageReservation = () => {
        axios
            .post("http://localhost:8080/cottage_reservations/create", {
                cottageId: cottageId,
...
return (
    <div>   
        <br />
        <br />
        <Button onClick={() => createCottageReservation()} variant="contained" color="primary">Create Reservation</Button>
        <br />
        <br />
...
export default CreateCottageReservation;