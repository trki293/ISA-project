...
const CreateInstructionsReservation = () => {
    ...
    useEffect(() => {
        ...
        alert(splitID[5]);
        setInstructionsId(splitID[5]);
        setBeginDate(splitID[6]);
        setEndDate(splitID[7]);

        axios
            .get("http://localhost:8080/instructions/getAdditionalServicesForInstructions/" + splitID[5], {
    ...
    const createInstructionsReservation = () => {
        axios
            .post("http://localhost:8080/instructions_reservations/create", {
...
return (
    <div>   
        <br />
        <br />
        <Button onClick={() => createInstructionsReservation()} variant="contained" color="primary">Create Reservation</Button>
        <br />
        <br />
        <TextField label="ID Of Instructions" value={instructionsId} id="outlined-basic" variant="outlined" size="small" />
        <br />
        <br />
...
export default CreateInstructionsReservation;