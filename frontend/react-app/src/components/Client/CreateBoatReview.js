...
const CreateBoatReview = () => {
    ...
    useEffect(() => {
        ...
        setBoatReservationId(splitID[6]);
    }, []);

    const createBoatReview = () => {
        axios
            .post("http://localhost:8080/boat_reviews/create", {
                boatReservationId: boatReservationId,
                content: content,
                rating: grade,
    ...
    return (
        <div>
            <br />
            <br />
            <TextField label="ID of Boat Reservation" value={boatReservationId} id="outlined-basic" variant="outlined" size="small" />
            <br />
            <br />
            <TextField
            ...
            <br />
            <br />
            <Button onClick={() => createBoatReview()} variant="contained" color="primary">Create Review</Button>
            <br />
            <br />
...
export default CreateBoatReview;