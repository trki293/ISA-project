import {
  ...
  const GetAllInstructionsUnauthorize = () => {
    ...
    const [maxValueMaxNumberOfPeopleSearch, setMaxValueMaxNumberOfPeopleSearch] = useState(-1);
    const [minValueMaxNumberOfPeopleSearch, setMinValueMaxNumberOfPeopleSearch] = useState(-1);
    ...
    useEffect(() => {
      axios
        .post("http://localhost:8080/instructions/unauthenticated/getAllInstructions", {
          "title": "",
          "minAverageGrade": -1,
          "maxAverageGrade": -1,
          "city": "",
          ...
          "minPricePerHour": -1,
          "maxPricePerHour": -1,
          "minValueMaxNumberOfPeople": -1,
          "maxValueMaxNumberOfPeople": -1
        }
        )
        .then((res) => {
          setRows(res.data);
    ...
    const handleSubmit = (event) => {
      ...
      axios
        .post("http://localhost:8080/instructions/unauthenticated/getAllInstructions", {
          ...
          "minValueMaxNumberOfPeople": minValueMaxNumberOfPeopleSearch,
          "maxValueMaxNumberOfPeople": maxValueMaxNumberOfPeopleSearch
        }
        )
        .then((res) => {
          setRows(res.data);
    ...
    const hideAndResetHandler = () => {
      ...
      axios
        ...
        setMinValueMaxNumberOfPeopleSearch(-1);
        setMaxPricePerHourSearch(-1);
        setMaxAverageGradeSearch(-1);
        setMaxValueMaxNumberOfPeopleSearch(-1);
        setTitleSearch("");
        setCitySearch("");
        setCountrySearch("");
    }
    ...
    return (
      <div>
        ...
        <form hidden={showForm} onSubmit={handleSubmit}>
          ...
          <label>Min Value Max Number Of People:&nbsp;&nbsp;
            <input
              type="text"
              value={minValueMaxNumberOfPeopleSearch}
              onChange={(e) => setMinValueMaxNumberOfPeopleSearch(e.target.value)}
            />&nbsp;&nbsp;&nbsp;&nbsp;
          </label>
          <label>Max Value Max Number Of People:&nbsp;&nbsp;
            <input
              type="text"
              value={maxValueMaxNumberOfPeopleSearch}
              onChange={(e) => setMaxValueMaxNumberOfPeopleSearch(e.target.value)}
            />
          </label><br /><br />
          <input type="submit" />
  ...
  export default GetAllInstructionsUnauthorize;